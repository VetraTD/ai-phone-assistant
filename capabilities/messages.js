...
const MESSAGE_PROTOCOL_SECTION =
  ...
  `1. Name: ask for it, then repeat it back once — "Thanks, Marcus — " — so they can correct you if you misheard. Only if they correct you or you are still unsure, ask them to spell the ONE part you are unsure of (first name or surname, not both), and not at all if you already confirmed it earlier in this call.\n` +
