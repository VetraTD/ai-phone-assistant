...
const [settingsDefaultLanguage, setSettingsDefaultLanguage] =
useState("en");
...
<select
value={settingsDefaultLanguage}
onChange={(e) => setSettingsDefaultLanguage(e.target.value)}
>
...
<div className="empty-note">
This saves your business name, timezone, preferred language,
greeting, after-hours policy, transfer settings, and
