 ...
 *                                Needed since the dashboard took the root: on
 *                                the app build the logo points at the marketing
 *                                site, which is this same codebase served from
 *                                a different origin, and <Link> would try to
 *                                route to it inside this SPA.
 */
