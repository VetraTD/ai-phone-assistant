    ...
    try {
      ...
      for await (const ev of gen) {
        ...
        if (ev.type === "delta") {
          ...
          // A tool round has begun, so this turn may already have written
          // something. From here the resume path must not discard it — see
          // shouldAbortForResume's toolStarted case.
          if (inFlightTurn) inFlightTurn.toolStarted = true;
