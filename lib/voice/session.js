    ...
    try {
      ...
      for await (const ev of gen) {
        ...
        if (ev.type === "delta") {
          ...
          //
          // Debounced rather than immediate: most tools answer in well under
          // this, and "One moment." in front of an instant answer is chatter.
          // The timer is cancelled by the tool finishing or by any text
          // arriving, so only a genuinely slow round is ever covered.
