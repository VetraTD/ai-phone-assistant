...
import { resolveGoogleVoice, resolveRingTone, resolveLocale } from "./voiceLocale.js";
...
export function mapLanguage(config) {
  ...
  //
  // resolveLocale (lib/voice/voiceLocale.js) already worked this out — from the
  // chosen voice's accent, or a Europe/London timezone — it was simply never
  // wired to STT, only to the Google TTS fallback and the Twilio ringback.
  if (first === "en") {
    return resolveLocale(config) === "en-GB" ? "en-GB" : "en-US";
  }
