 ...
 * @returns {boolean}
 */
export function shouldPlayHoldLine({ producedText, holdLinePlayed, spokenThisTurn, promiseRe }) {
  if (producedText) return false;
    ...
    try {
      ...
      for await (const ev of gen) {
        ...
        if (ev.type === "delta") {
          ...
          // only producedText, which is false BY CONSTRUCTION here (that is why
