...
export async function handleLiveSessionConnection(ws, _req, deps = {}) {
  ...
  function auditTurn() {
    ...
    if (unbackedByAction) {
      ...
      if (signOffRestatement) bumpCounter("live_claim_signoff_restatement");
      else if (readBackNotClaim) bumpCounter("live_claim_readback_not_claim");
      else if (existingReport) bumpCounter("live_claim_existing_report");
