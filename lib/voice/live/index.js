  ...
  function finish(reason) {
    ...
    if (postCall !== "off" && state.businessId && state.dbCallId) {
      ...
      recover({
        ...
        // caller affirm a read-back at any point. The recovery reads it ONLY to
        // refuse, exactly as the LVX117 gate does -- its absence means nothing
        // was ever agreed, and no reader's verdict may override that.
        agreed: lastAgreement != null,
        mode: judgeMode(env),
      })
