 ...
 */
function liveLanguageCode(config, businessPhone) {
  ...
  async function onStart(startData) {
    ...
    const config_ = {
      ...
      speechConfig: {
        ...
        languageCode: liveLanguageCode(config, state.twilioNumber),
      },
    ...
    try {
      ...
      log.info("live_session_open", {
        ...
        language_code: liveLanguageCode(state.config, state.twilioNumber),
