...
export function createCallSummary({ arm, model = null, surface = null, languagePinned = null }) {
  ...
  // caller was never asked whether they needed anything else. It is capped at
  // one per call by the latch in lib/voice/live/tools.js, so a 1 here is the
  // guard working and a 2 would be a bug in the latch rather than a chatty
  // model.
