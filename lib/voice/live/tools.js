  ...
  async function handleToolCall(toolCall) {
    ...
    for (const fc of calls) {
      ...
      const ctx = {
        ...
        // DECIDES, not measures. A field produced by turnState and not copied
        // here reads undefined downstream -- the defect lastCallerText had for
        // the life of a deployment -- and here that silently restores the
        // fail-closed path, refusing every re-worded read-back.
        lastAgreementReadBackText: state.lastAgreementReadBackText ?? null,
