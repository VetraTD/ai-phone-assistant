  ...
  async function handleToolCall(toolCall) {
    ...
    for (const fc of calls) {
      ...
      const ctx = {
        ...
        // LVX114. Set only by completeClaimedBooking, and it skips exactly one
        // gate in services/tools.js: the consent / write-order question, which
        // is moot once the caller has already been told the thing is done.
        // Copied here for the reason written directly above -- the producer and
        // the consumer each had tests and nothing proved they were connected.
        completingClaim: state.completingClaim === true,
