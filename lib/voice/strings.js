...
export const STRINGS = {
  en: {
    ...
    holdAvailability: "Let me check the diary for you.",
    holdLookup: "Let me pull that up.",
    holdWrite: "Just getting that sorted for you.",
  ...
  es: {
    filler: "Un momento.",
    holdAvailability: "Déjeme revisar la agenda.",
    holdLookup: "Déjeme buscar eso.",
    holdWrite: "Ya se lo estoy registrando.",
