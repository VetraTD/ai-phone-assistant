...
export const STRINGS = {
  en: {
    ...
    goodbyeWithPhone: (phone) =>
      `It seems like you may have stepped away. Feel free to call us back at ${phone} anytime. Goodbye!`,
    goodbyeNoPhone:
  ...
  es: {
    ...
    goodbyeWithPhone: (phone) =>
      `Parece que se ha alejado. Puede llamarnos de nuevo al ${phone} cuando guste. ¡Hasta luego!`,
    goodbyeNoPhone:
      "Parece que se ha alejado. Puede llamarnos de nuevo cuando guste. ¡Hasta luego!",
