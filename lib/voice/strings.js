...
export const STRINGS = {
  en: {
    ...
    //
    // SHORT on purpose. The line is pure cost when the answer beats it: audio
    // plays serially, so every word here delays the reply behind it. A caller
    // asked for these to be less formal and less of a speech, and short happens
    // to be the same thing as cheap.
    //
    ...
    holdAvailability: ["Let me check.", "One sec, checking the calendar.", "Let me see what is open."],
    holdLookup: ["Let me pull that up.", "One sec, finding that now."],
    holdBook: ["Getting that booked now.", "Putting that on the calendar."],
    holdReschedule: ["Moving that for you.", "Getting that changed now."],
    holdCancel: ["Canceling that now.", "Taking care of that now."],
  ...
  es: {
    filler: "Un momento.",
    holdAvailability: ["Déjeme revisar.", "Un segundo, reviso la agenda.", "Veo qué hay libre."],
    holdLookup: ["Se lo busco.", "Un segundo, lo busco."],
    holdBook: ["Se la agendo ahora.", "Reservando esa hora."],
    holdReschedule: ["Se la cambio ahora.", "Moviendo esa cita."],
    holdCancel: ["Se la cancelo ahora.", "Cancelando ahora."],
...
export const HOLD_KINDS = [...new Set(Object.values(HOLD_KIND_BY_TOOL))].filter(Boolean);
