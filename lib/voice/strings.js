...
export const STRINGS = {
  en: {
    ...
    // number.
    closingTicRe:
      /\b(?:is|was)\s+there\s+anything\s+else\b|\banything\s+else\s+(?:i|we)\s+(?:can|could)\b|\banything\s+else\s+(?:for\s+you|you\s+need|today)\b/i,
  },
