...
const COUNTER_NAMES = [
  ...
  // they said was carried into the first turn rather than dropped. Expected to
  // be non-zero — it is the measure of how often making the greeting
  // uninterruptible actually costs a caller anything, and the evidence that
  // the carry-forward is doing its job rather than silently discarding.
