...
const COUNTER_NAMES = [
  ...
  // More than one question mark in a single assistant turn.
  //
  // Counting "?" rather than matching phrasings is deliberate on two grounds.
  // It is exact and free -- no model round-trip on the happy path, where reply
  // p50 is 1.3-2.5 s and the caller feels every added turn. And it is immune to
  // LVX73: a vendor transcription fragment that was never spoken cannot
  // manufacture a question mark, where a phrasing list could be tripped by one.
