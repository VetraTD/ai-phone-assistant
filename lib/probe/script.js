...
export const DEMO_BOOKING_LINES = [
  ...
  { label: "demo_reason", text: "I've had some tooth pain on the left side for about a week." },
  { label: "demo_when", text: "Tomorrow afternoon would be good." },
  { label: "demo_accept", text: "Yes, that one works." },
  // Only now, and only because it was asked for.
  { label: "demo_name", text: "It's Nithin Dodla." },
  { label: "demo_spell", text: "That's N, I, T, H, I, N. D, O, D, L, A." },
...
export const DEMO_CANCEL_LINES = [
  ...
  { label: "cx_rebook", text: "Now can I book a new one for next Tuesday morning?" },
  { label: "cx_accept", text: "Yes, that works." },
  { label: "cx_name", text: "It's Nithin Dodla." },
  { label: "cx_spell", text: "N, I, T, H, I, N. D, O, D, L, A." },
