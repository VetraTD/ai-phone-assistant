...
-- ---------------------------------------------------------------------------
-- Operator-only attach for imported tenants (migration 040, ledger P25).
-- Granted to NOBODY on purpose — it takes a business id as an argument, so on
-- a request path it would be a tenant-hopping primitive.
-- ---------------------------------------------------------------------------
